...
function Navbar() {
  ...
  <div className="max-w-7xl mx-auto px-3 md:px-8 py-3 flex items-center justify-between">

    <div className="hidden md:flex bg-white p-3 rounded-xl shadow-sm">
      <MdFastfood className="text-pink-500 text-2xl" />
    </div>

    <form className="flex flex-1 mx-3 bg-white rounded-full px-4 py-2 items-center gap-2 border border-gray-200 focus-within:ring-2 focus-within:ring-pink-300 transition">
